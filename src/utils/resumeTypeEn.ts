...
export function validateLanguage(type,language) {
  ...
  if (type == "workInfo" && language == "1") {
    return {
      ...
      monthSalary: {label: "Gross Monthly", message: "请输入综合月薪"},
      ...
      personnelStructure: {label: "Team Structure", message: "请输入团队构架"},
      shopVolume: {label: "Business Volume", message: "请输入业绩体量"},
  ...
  if (type == "workInfo" && language != "1") {
    return {
      ...
      shopVolume: {label: "业绩体量", message: "请输入业绩体量"},
  ...
  if (type == "educationInfo" && language != "1") {
    return {
      ...
      atSchool: {label: "应届生", message: "请选择应届毕业生"},
