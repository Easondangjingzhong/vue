  ...
  >
    ...
    <div>
      <a-form :model="outsourceSocialSecurityForm" :label-col="labelCol" @finish="handleSubmit">
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item name="shebaoZuidiJishu" label="最低基数" :rules="[{ required: true, message: '请填写最低基数' }]">
               <a-input v-model:value="outsourceSocialSecurityForm.shebaoZuidiJishu" />
            </a-form-item>
          </a-col>
           <a-col :span="12">
             <a-form-item name="shebaoShijiJishu" label="实际基数" :rules="[{ required: true, message: '请填写实际基数' }]">
               <a-input v-model:value="outsourceSocialSecurityForm.shebaoShijiJishu" />
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="24">
         ...
         <a-row :gutter="24">
          ...
          <a-col :span="12">
            <a-form-item name="yijinZuidiJishu" label="最低基数" :rules="[{ required: true, message: '请填写最低基数' }]">
               <a-input v-model:value="outsourceSocialSecurityForm.yijinZuidiJishu" />
            </a-form-item>
          </a-col>
           <a-col :span="12">
             <a-form-item name="yijinShijiJishu" label="实际基数" :rules="[{ required: true, message: '请填写实际基数' }]">
               <a-input v-model:value="outsourceSocialSecurityForm.yijinShijiJishu" />
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="24">
        ...
        <a-row :gutter="24" style="height: 28px; line-height: 25px;">
        ...
        <a-row :gutter="24" style="height: 28px; line-height: 25px;">
          ...
          <a-col :span="3" style="padding: 0 3px 0 0;"><a-form-item name="yanglaoRate"><a-input v-model:value="outsourceSocialSecurityForm.yanglaoRate" disabled /></a-form-item></a-col>
          ...
          <a-col :span="3" style="padding: 0 3px 0 0;"><a-form-item name="yanglaoCompanyRate"><a-input v-model:value="outsourceSocialSecurityForm.yanglaoCompanyRate" disabled /></a-form-item></a-col>
        ...
        <a-row :gutter="24" style="height: 28px; line-height: 25px;">
          ...
          <a-col :span="3" style="padding: 0 3px 0 0;"><a-form-item name="shiyeRate"><a-input v-model:value="outsourceSocialSecurityForm.shiyeRate" disabled /></a-form-item></a-col>
          ...
          <a-col :span="3" style="padding: 0 3px 0 0;"><a-form-item name="shiyeCompanyRate"><a-input v-model:value="outsourceSocialSecurityForm.shiyeCompanyRate" disabled /></a-form-item></a-col>
        ...
        <a-row :gutter="24" style="height: 28px; line-height: 25px;">
          ...
          <a-col :span="3" style="padding: 0 3px 0 0;"><a-form-item name="yiliaoRate"><a-input v-model:value="outsourceSocialSecurityForm.yiliaoRate" disabled /></a-form-item></a-col>
          ...
          <a-col :span="3" style="padding: 0 3px 0 0;"><a-form-item name="yiliaoCompanyRate"><a-input v-model:value="outsourceSocialSecurityForm.yiliaoCompanyRate" disabled /></a-form-item></a-col>
        ...
        <a-row :gutter="24" style="height: 28px; line-height: 25px;">
          ...
          <a-col :span="3" style="padding: 0 3px 0 0;"><a-form-item name="dabingRate"><a-input v-model:value="outsourceSocialSecurityForm.dabingRate" disabled /></a-form-item></a-col>
          ...
          <a-col :span="3" style="padding: 0 3px 0 0;"><a-form-item name="dabingCompanyRate"><a-input v-model:value="outsourceSocialSecurityForm.dabingCompanyRate" disabled /></a-form-item></a-col>
        ...
        <a-row :gutter="24" style="height: 28px; line-height: 25px;">
          ...
          <a-col :span="3" style="padding: 0 3px 0 0;"><a-form-item name="yijinRate"><a-input v-model:value="outsourceSocialSecurityForm.yijinRatio" disabled /></a-form-item></a-col>
          ...
          <a-col :span="3" style="padding: 0 3px 0 0;"><a-form-item name="yijinCompanyRate"><a-input v-model:value="outsourceSocialSecurityForm.yijinCompanyRate" disabled /></a-form-item></a-col>
        ...
        <a-row :gutter="24" style="height: 28px; line-height: 25px;">
          ...
          <a-col :span="3" style="padding: 0 3px 0 0;"><a-form-item name="gongshangCompanyRate"><a-input v-model:value="outsourceSocialSecurityForm.gongshangCompanyRate" disabled /></a-form-item></a-col>
        ...
        <a-row :gutter="24" style="height: 28px; line-height: 25px;">
          ...
          <a-col :span="3" style="padding: 0 3px 0 0;"><a-form-item name="shengyuCompanyRate"><a-input v-model:value="outsourceSocialSecurityForm.shengyuCompanyRate" disabled /></a-form-item></a-col>
...
const handleChangeShebaoStatus = () => {
  if ((outsourceSocialSecurityForm.value.shebaoStatus == '2' || outsourceSocialSecurityForm.value.shebaoStatus == '3')&& outsourceSocialSecurityForm.value.shebaoYujiaoTime) {
    outsourceDetailStore.queryOutsourceShebaoContractRates().then(res => {
      if (res.code == 1 && res.info.length > 0) {
        ...
        outsourceSocialSecurityForm.value.yanglaoPerson = p.personYanglaoBase * p.personYanglaoRate;
        ...
        outsourceSocialSecurityForm.value.yanglaoCompany = p.companyYanglaoBase * p.companyYanglaoRate;
        ...
        outsourceSocialSecurityForm.value.shiyePerson = p.companyShiyeBase;
        ...
        outsourceSocialSecurityForm.value.shiyeCompany = p.companyShiyeBase * p.companyShiyeRate;
        ...
        outsourceSocialSecurityForm.value.yiliaoPerson = p.personYiliaoBase * p.personYiliaoRate;
        ...
        outsourceSocialSecurityForm.value.yiliaoCompany = p.companyYiliaoBase * p.companyYiliaoRate;
        ...
        outsourceSocialSecurityForm.value.dabingPerson = p.personDabingBase * p.personDabingRate;
        ...
        outsourceSocialSecurityForm.value.dabingCompany = p.companyDabingBase * p.companyDabingRate;
        ...
        outsourceSocialSecurityForm.value.yijinPerson = p.personYijinBase * p.personYijinRate;
        ...
        outsourceSocialSecurityForm.value.yijinCompany = p.companyYijinBase * p.companyYijinRate;
        ...
        outsourceSocialSecurityForm.value.gongshangCompany = p.companyGongshangBase * p.companyGongshangRate;
        ...
        outsourceSocialSecurityForm.value.shengyuCompany = p.companyShengyuBase * p.companyShengyuRate;

        outsourceSocialSecurityForm.value.personTotal = outsourceSocialSecurityForm.value.yanglaoPerson + outsourceSocialSecurityForm.value.shiyePerson + outsourceSocialSecurityForm.value.yiliaoPerson + outsourceSocialSecurityForm.value.dabingPerson + outsourceSocialSecurityForm.value.yijinPerson;
        outsourceSocialSecurityForm.value.companyTotal = outsourceSocialSecurityForm.value.yanglaoCompany + outsourceSocialSecurityForm.value.shiyeCompany + outsourceSocialSecurityForm.value.yiliaoCompany + outsourceSocialSecurityForm.value.dabingCompany + outsourceSocialSecurityForm.value.yijinPerson + outsourceSocialSecurityForm.value.shengyuCompany + outsourceSocialSecurityForm.value.gongshangCompany;
