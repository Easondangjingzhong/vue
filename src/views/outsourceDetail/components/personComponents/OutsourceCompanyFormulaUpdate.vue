 ...
 <a-drawer
  ...
  >
    <template #extra>
     ...
     <div>
      <a-form :label-col="labelCol" layout="vertical" :hideRequiredMark="true" :model="outsourceFormulaForm" @finish="handleSubmit">
        ...
        <a-row :gutter="24">
          <a-col :span="5">
            <a-form-item label="计薪周期" name="cycle" :rules="[{ required: true, message: '请选择计薪周期' }]">
          ...
          <a-col :span="3">
            <a-form-item label="业绩月" name="offerDetailMonth" :rules="[{ required: true, message: '请选择业绩月' }]">
              <a-select v-model:value="outsourceFormulaForm.offerDetailMonth">
                <a-select-option value="当月">当月</a-select-option>
                <a-select-option value="下月">下月</a-select-option>
              </a-select>
            </a-form-item>
          ...
          <a-col :span="4">   
            <a-form-item label="考勤日" name="kaoQinBiao" :rules="[{ required: true, message: '请选择考勤日' }]">
              <div style="display: flex; width: 100%;">
                ...
                <a-select v-model:value="outsourceFormulaForm.kaoQinBiao" placeholder="请选择考勤日" :options="kaoQinBiaoOptions" style="flex: 1;" class="select-right"></a-select>
              </div>
             </a-form-item>
          </a-col>
          <a-col :span="4">         
            <a-form-item label="账单日" name="zhanDanRi" :rules="[{ required: true, message: '请选择账单日' }]">
              <div style="display: flex; width: 100%;">
                ...
                <a-select v-model:value="outsourceFormulaForm.zhanDanRi" :options="kaoQinBiaoOptions" style="flex: 1;" class="select-right"></a-select>
              </div>
            </a-form-item>
          </a-col>
          <a-col :span="4">
            <a-form-item label="薪资日" name="xinZiRi">
               <a-select v-model:value="outsourceFormulaForm.xinZiRi">
                <a-select-option value="当月-31日">当月-31日</a-select-option>
                <a-select-option value="下月-5日">下月-5日</a-select-option>
                <a-select-option value="下月-15日">下月-15日</a-select-option>
                <a-select-option value="下月-31日">下月-31日</a-select-option>
              </a-select>
            </a-form-item>
          </a-col>
        </a-row>
         ...
         <a-row :gutter="24" style='display: none;'>
           <a-col :span="4">         
            <a-form-item label="年假" name="nianJia">
        ...
        <a-row :gutter="24">
           <a-col :span="8">         
            <a-form-item :label="outsourceFormulaForm.jobType == '兼职' ? '客户招聘(社会)' : '客户招聘'" name="keZhaoGongShi" :labelCol="{span: (outsourceFormulaForm.jobType == '兼职' ? 10 : 4)}">
          ...
          <a-col :span="8">         
            <a-form-item :label="outsourceFormulaForm.jobType == '兼职' ? '公司招聘(社会)' : '公司招聘'" name="gongZhaoGongShi" :labelCol="{span: (outsourceFormulaForm.jobType == '兼职' ? 10 : 4)}">
        ...
        <a-row :gutter="24" v-if="outsourceFormulaForm.jobType == '兼职'">
          <a-col :span="8">         
            <a-form-item label="客户招聘(学生)" name="keZhaoGongShiStudent" :labelCol="{span: 10}">
          ...
          <a-col :span="8">         
            <a-form-item label="公司招聘(学生)" name="gongZhaoGongShiStudent" :labelCol="{span: 10}">
...
const kaoQinBiaoOptions = ref(Array.from({ length: 31 }, (_, i) => ({ label: `${i + 1}日`, value: `${i + 1}日` })));
...
watch(outsourceFormulaForm, () => {
  if (outsourceFormulaForm.value.kaoQinBiao && outsourceFormulaForm.value.kaoQinBiao.split('-').length === 2) {
    outsourceFormulaForm.value.kaoQinBiaoCurrent = outsourceFormulaForm.value.kaoQinBiao.split('-')[0];
    outsourceFormulaForm.value.kaoQinBiao = outsourceFormulaForm.value.kaoQinBiao.split('-')[1];
  }
  if (outsourceFormulaForm.value.zhanDanRi && outsourceFormulaForm.value.zhanDanRi.split('-').length === 2) {
    outsourceFormulaForm.value.zhanDanRiCurrent = outsourceFormulaForm.value.zhanDanRi.split('-')[0];
    outsourceFormulaForm.value.zhanDanRi = outsourceFormulaForm.value.zhanDanRi.split('-')[1];
  }
})
...
const handleSubmit = () => {
  ...
  outsourceFormulaForm.value.kaoQinBiao = `${outsourceFormulaForm.value.kaoQinBiaoCurrent}-${outsourceFormulaForm.value.kaoQinBiao}`;
  outsourceFormulaForm.value.zhanDanRi = `${outsourceFormulaForm.value.zhanDanRiCurrent}-${outsourceFormulaForm.value.zhanDanRi}`;
...
<style lang="less" scoped>
  ...
  :deep(.select-left .ant-select-selector) {
    border-top-right-radius: 0 !important;
    border-bottom-right-radius: 0 !important;
  }
  :deep(.select-right .ant-select-selector) {
