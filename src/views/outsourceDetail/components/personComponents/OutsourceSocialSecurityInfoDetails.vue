<template>
 <a-drawer
    v-model:open="outsourceSocialSecuritInfoDetailsFlag"
    title="基数详情"
    :maskClosable="false"
    :keyboard="false"
    :closable="false"
  ...
  >
    <template #extra>
      <CloseOutlined @click="outsourceSocialSecuritInfoDetailsFlag = false" />
    </template>
    <a-table
      size="small"
      :pagination="false"
      rowKey="key"
      :columns="columns"
      :dataSource="getOutsourceSocialSecuritInfoDetailsList"
      :scroll="{ x: 2000 }"
    >
...
const { outsourceSocialSecuritInfoDetailsFlag,getOutsourceSocialSecuritInfoDetailsList } = storeToRefs(outsourceDetailStore);
