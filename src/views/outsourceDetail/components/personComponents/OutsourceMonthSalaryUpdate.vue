...
const monthTax = computed(() => {
  ...
  // }
  return (parseFloat(outsourceMonthSalaryForm.value.chuqinSalary || '0') + parseFloat(outsourceMonthSalaryForm.value.canbu || '0') + parseFloat(outsourceMonthSalaryForm.value.jintie || '0') + parseFloat(outsourceMonthSalaryForm.value.quanqin || '0') + parseFloat(outsourceMonthSalaryForm.value.jiabanSalary || '0') + parseFloat(outsourceMonthSalaryForm.value.jiangjinTotal || '0') + parseFloat(outsourceMonthSalaryForm.value.baodiJiangjin || '0') + parseFloat(outsourceMonthSalaryForm.value.tiaochaTotal || '0') + parseFloat(outsourceMonthSalaryForm.value.thirteenthSalary || '0') + parseFloat(outsourceMonthSalaryForm.value.yearEndBouns || '0') + parseFloat(outsourceMonthSalaryForm.value.otherPayKe || '0') + parseFloat(outsourceMonthSalaryForm.value.welfareKe || '0')).toFixed(2).toString();
});
watch(monthTax, () => {
