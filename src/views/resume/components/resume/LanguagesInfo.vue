  ...
  <div>
    <a-card class="resume_card">
      ...
      <a-col :span="24">
        ...
        <a-checkbox value="IELTS">IELTS</a-checkbox>
        <a-checkbox value="TOEFL">TOEFL</a-checkbox>
...
const onChangeLanguageAbility = () => {
  console.log(languageAbility0.value);
  ...
  if (languageAbility00.length > 0) {
    ...
    if (languageAbility00.includes("1")) {
     ...
     if (languageAbility00.includes("3")) {
      ...
      language.bujia = "";
      let languageLevel = languageAbility00.filter((item) => item != "1" && item != "2" && item != "3").join(",");
  ...
  if (languageAbility11.length > 0) {
    ...
    if (languageAbility11.includes("1")) {
     ...
     if (languageAbility11.includes("3")) {
      ...
      language.bujia = "";
      let languageLevel = languageAbility11.filter((item) => item != "1" && item != "2" && item != "3").join(",");
      language.languageLevel = languageLevel;
    }
     // @ts-ignore
    languageAbility.push(language);
  ...
  if (languageAbility22.length > 0) {
    ...
    if (languageAbility22.includes("1")) {
     ...
     if (languageAbility22.includes("3")) {
      ...
      language.bujia = "";
      let languageLevel = languageAbility22.filter((item) => item != "1" && item != "2" && item != "3").join(",");
    language.languageLevel = languageLevel;
    }
  ...
  if (languageAbility33.length > 0) {
    ...
    if (languageAbility33.includes("1")) {
     ...
     if (languageAbility33.includes("3")) {
      ...
      language.bujia = "";
      let languageLevel = languageAbility33.filter((item) => item != "1" && item != "2" && item != "3").join(",");
    language.languageLevel = languageLevel;
    }
  ...
  if (languageAbility55.length > 0) {
    ...
    if (languageAbility55.includes("1")) {
     ...
     if (languageAbility55.includes("3")) {
      ...
      language.bujia = "";
      let languageLevel = languageAbility55.filter((item) => item != "1" && item != "2" && item != "3").join(",");
    language.languageLevel = languageLevel;
    }
  ...
  if (languageAbility66.length > 0) {
    ...
    if (languageAbility66.includes("1")) {
     ...
     if (languageAbility66.includes("3")) {
      ...
      language.bujia = "";
      let languageLevel = languageAbility66.filter((item) => item != "1" && item != "2" && item != "3").join(",");
      language.languageLevel = languageLevel;
    }
